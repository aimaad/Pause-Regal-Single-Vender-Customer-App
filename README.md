...
-Download the generated file: android/app/google-services.json
-Place it in: android/app/google-services.json

### 🍏 iOS Setup

-Add your iOS app in Firebase Console
-Download the file: ios/Runner/GoogleService-Info.plist
...
Android
Add your API key inside android/app/src/main/AndroidManifest.xml:
```bash
<meta-data
