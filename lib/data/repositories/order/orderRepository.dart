...
class OrderRepository {
  ...
  Future<OrderModel> updateOrderStatus(
    ...
    try {
      OrderModel result = await _orderRemoteDataSource.updateOrderStatus(
  ...
  Future<OrderLiveTrackingModel> getOrderLiveTrackingData(
      String? orderId) async {
    try {
      OrderLiveTrackingModel result =
          await _orderRemoteDataSource.getOrderLiveTracing(orderId: orderId);
      return result;
    } on ApiMessageAndCodeException catch (e) {
      ApiMessageAndCodeException apiMessageAndCodeException = e;
      throw ApiMessageAndCodeException(
