...
class PaymentRepository {
  ...
  Future<String> getPayment(
      String? userId, String? orderId, String? amount) async {
    try {
      final result =
          await _paymentRemoteDataSource.getPayment(userId, orderId, amount);
      return result;
  ...
  Future<Map<String, dynamic>> sendWalletRequest(
      String? amount, String? paymentAddress) async {
    try {
      final result = await _paymentRemoteDataSource.sendWalletRequest(
          amount, paymentAddress);
      return result;
    } on ApiMessageAndCodeException catch (e) {
      ApiMessageAndCodeException apiMessageAndCodeException = e;
      throw ApiMessageAndCodeException(
