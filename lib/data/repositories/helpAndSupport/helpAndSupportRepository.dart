...
class HelpAndSupportRepository {
  static final HelpAndSupportRepository _helpAndSupportRepository =
  ...
  factory HelpAndSupportRepository() {
    _helpAndSupportRepository._helpAndSupportRemoteDataSource =
        HelpAndSupportRemoteDataSource();
  ...
  Future<List<HelpAndSupportModel>> getHelpAndSupport() async {
    try {
      List<HelpAndSupportModel> result =
          await _helpAndSupportRemoteDataSource.getHelpAndSupport();
      return result;
    } catch (e) {
  ...
  Future getAddTicket(String? ticketTypeId, String? subject, String? email,
    ...
    try {
      final result = await _helpAndSupportRemoteDataSource.getAddTicket(
          ticketTypeId, subject, email, description);
      return result;
  ...
  Future getEditTicket(String? ticketId, String? ticketTypeId, String? subject,
    ...
    try {
      final result = await _helpAndSupportRemoteDataSource.getEditTicket(
          ticketId, ticketTypeId, subject, email, description, status);
      return result;
    } on ApiMessageAndCodeException catch (e) {
      ApiMessageAndCodeException apiMessageAndCodeException = e;
      throw ApiMessageAndCodeException(
