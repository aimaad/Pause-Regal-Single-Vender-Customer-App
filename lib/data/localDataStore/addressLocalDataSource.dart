...
class AddressLocalDataSource {
  ...
  String getMinimumFreeDeliveryOrderAmount() {
    return Hive.box(addressBox)
        .get(minimumFreeDeliveryOrderAmountBoxKey, defaultValue: "");
  }
  ...
  Future<void> setMinimumFreeDeliveryOrderAmount(
      String minimumFreeDeliveryOrderAmount) async {
    return Hive.box(addressBox).put(
        minimumFreeDeliveryOrderAmountBoxKey, minimumFreeDeliveryOrderAmount);
  }
