...
class ProductSearchCubit extends Cubit<ProductSearchState> {
  ...
  void fetchProductSearch(String limit, String? search, String vegetarian,
      String? latitude, String? longitude, String? userId, String? cityId) {
  ...
  void fetchMoreProductSearchData(
    ...
    _fetchData(
            limit: limit,
            offset: (state as ProductSearchSuccess)
                .productSearchList
                .length
                .toString(),
            search: search,
      ...
      final List<ProductDetails> usersDetails = value;
      final List<ProductDetails> updatedUserDetails =
          List.from(oldState.productSearchList);
      updatedUserDetails.addAll(usersDetails);
      emit(ProductSearchSuccess(updatedUserDetails, oldState.totalData,
