...
class OrderLiveTrackingCubit extends Cubit<OrderLiveTrackingState> {
  ...
  OrderLiveTrackingCubit(this._orderRepository)
  ...
  void getOrderLiveTracking({
    ...
    _orderRepository
        .getOrderLiveTrackingData(orderId)
        .then((value) => emit(OrderLiveTrackingSuccess(value)))
        .catchError((e) {
      ApiMessageAndCodeException apiMessageAndCodeException = e;
      emit(OrderLiveTrackingFailure(
