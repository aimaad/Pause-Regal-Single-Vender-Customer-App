...
class SetProductRatingCubit extends Cubit<SetProductRatingState> {
  ...
  SetProductRatingCubit(this._ratingRepository)
      : super(SetProductRatingInitial());

  void setProductRating(
      String? userId, List? productRatingDataString, String? orderId) {
