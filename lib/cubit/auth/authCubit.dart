...
class AuthCubit extends Cubit<AuthState> {
  ...
  void updateUserProfileUrl(String profileUrl) {
    ...
    emit(
        (Authenticated(authModel: oldUserDetails.copyWith(image: profileUrl))));
  }
  ...
  void updateUserLatitude(String latitude) {
    ...
    emit((Authenticated(
        authModel: oldUserDetails.copyWith(latitude: latitude))));
  }
  ...
  void updateUserLongitude(String longitude) {
    ...
    emit((Authenticated(
        authModel: oldUserDetails.copyWith(latitude: longitude))));
  }
  ...
  void updateUserReferralCode(String referralCode) {
    ...
    emit((Authenticated(
        authModel: oldUserDetails.copyWith(referralCode: referralCode))));
  }
