...
class ProductRatingDetailScreen extends StatefulWidget {
  ...
  @override
  ProductRatingDetailScreenState createState() =>
      ProductRatingDetailScreenState();
        ...
        builder: (_) => MultiBlocProvider(
                providers: [
                  BlocProvider<GetProductRatingCubit>(
                    ...
                    child: ProductRatingDetailScreen(
...
class ProductRatingDetailScreenState extends State<ProductRatingDetailScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      context
          .read<GetProductRatingCubit>()
          .fetchGetProductRating(perPage, widget.productId!);
    });
    super.initState();
  }
  ...
  scrollListener() {
    if (controller.position.maxScrollExtent == controller.offset) {
      if (context.read<GetProductRatingCubit>().hasMoreData()) {
        context
            .read<GetProductRatingCubit>()
            .fetchMoreGetProductRatingData(perPage, widget.productId!);
      }
    }
  }
  ...
  Widget getProductRating() {
    return BlocConsumer<GetProductRatingCubit, GetProductRatingState>(
        ...
        builder: (context, state) {
          if (state is GetProductRatingProgress ||
              state is GetProductRatingInitial) {
            ...
            return Center(
              child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        UiUtils.getTranslatedLabel(context, noReviewFoundLabel),
          ...
          final productRatingList =
              (state as GetProductRatingSuccess).productRatingList;
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) {
                        ...
                        var inputDate = inputFormat.parse(
                            productRatingList[index].dataAdded!.toString());

                        var outputFormat = DateFormat('dd,MMM yyyy hh:mm a');
                        var outputDate = outputFormat.format(inputDate);
                        return hasMore &&
                                productRatingList.isEmpty &&
                                index == (productRatingList.length - 1)
                            ? Center(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                            ...
                                            Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                        " | ${productRatingList[index].rating!}",
                                                        textAlign:
                                                            TextAlign.left,
                                                        style: const TextStyle(
                                                            color:
                                        ...
                                        context.read<AuthCubit>().getId() ==
                                                productRatingList[index].userId!
                                            ? Row(
                                                mainAxisAlignment:
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              ...
              appBar: DesignConfig.appBar(
                  context,
                  width,
                  UiUtils.getTranslatedLabel(context, reviewsLabel),
                  const PreferredSize(
