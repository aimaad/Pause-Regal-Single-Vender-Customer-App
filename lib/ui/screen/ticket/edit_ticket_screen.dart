...
class EditTicketScreenState extends State<EditTicketScreen> {
  ...
  Widget selectType() {
    return BlocConsumer<HelpAndSupportCubit, HelpAndSupportState>(
        ...
        builder: (context, state) {
          ...
          _selectedIndex = helpAndSupportList
              .indexWhere((element) => element.id == widget.typeId.toString());
          return Container(
  ...
  Widget selectTypeDropdown() {
    return InkWell(
      ...
      child: Container(
        decoration:
            DesignConfig.boxDecorationContainer(textFieldBackground, 10.0),
        padding: EdgeInsetsDirectional.only(
            start: width! / 40.0,
            end: width! / 99.0,
            top: height! / 99.0,
  ...
  Widget email() {
    return Container(
      padding:
          EdgeInsetsDirectional.only(start: width! / 40.0, end: width! / 99.0),
      decoration:
          DesignConfig.boxDecorationContainer(textFieldBackground, 10.0),
              ...
              bottomNavigationBar:
                ...
                listener: (context, state) {
                  if (state is EditTicketSuccess) {
                    ...
                    UiUtils.setSnackBar(
                        StringsRes.ticketUpdateSuccessfully, context, false,
                        type: "1");
                    ...
                    child: Form(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.only(
                                  top: height! / 99.0, bottom: height! / 70.0),
                              child: DesignConfig.divider(),
                            ),
                            selectType(),
                            Padding(
