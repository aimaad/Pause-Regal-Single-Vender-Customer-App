...
class TransactionScreenState extends State<TransactionScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      context
          ...
          .fetchTransaction(perPage, transactionKey);
    });
  ...
  scrollListener() {
    if (controller.position.maxScrollExtent == controller.offset) {
      if (context.read<TransactionCubit>().hasMoreData()) {
        context
            .read<TransactionCubit>()
            .fetchMoreTransactionData(perPage, transactionKey);
      }
    }
  }
  ...
  Widget noTransactionData() {
    return NoDataContainer(
        ...
        subTitle: UiUtils.getTranslatedLabel(
            context, noTransactionFoundSubTitleLabel),
        width: width!,
        height: height!);
  }
  ...
  Future<void> refreshList() async {
    context.read<TransactionCubit>().fetchTransaction(perPage, transactionKey);
  }
      ...
      child: _connectionStatus == connectivityCheck
          ...
          : Scaffold(
              ...
              appBar: DesignConfig.appBar(
                  context,
                  width!,
                  UiUtils.getTranslatedLabel(context, transactionLabel),
                  const PreferredSize(
