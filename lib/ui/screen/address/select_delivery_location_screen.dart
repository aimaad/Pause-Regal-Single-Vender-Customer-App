...
class SelectDeliveryLocationScreen extends StatefulWidget {
  ...
  @override
  SelectDeliveryLocationScreenState createState() =>
      SelectDeliveryLocationScreenState();
...
class SelectDeliveryLocationScreenState
                ...
                return addressList.isNotEmpty
                    ? BlocProvider<UpdateAddressCubit>(
                        ...
                        child: Builder(builder: (context) {
                          return BlocConsumer<UpdateAddressCubit,
                                  UpdateAddressState>(
                              ...
                              listener: (context, state) {
                                if (state is UpdateAddressSuccess) {
                                  context
                                      .read<AddressCubit>()
                                      .updateAddress(state.addressModel);
                              ...
                              builder: (context, state) {
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    decoration: addressList[index].isDefault ==
                                            "1"
                                        ? DesignConfig
              ...
              appBar: AppBar(
                ...
                title: Text(
                    UiUtils.getTranslatedLabel(
                        context, selectDeliveryLocationLabel),
              ...
              bottomNavigationBar: TextButton(
                  ...
                  child: Container(
                      ...
                      decoration: DesignConfig.boxDecorationContainer(
                          Theme.of(context).colorScheme.primary, 10.0),
                      child: Text(
                          UiUtils.getTranslatedLabel(context, addAddressLabel),
                          textAlign: TextAlign.center,
                          maxLines: 1,
