...
class MapDataLoadSimmer extends StatelessWidget {
  ...
  const MapDataLoadSimmer({Key? key, this.width, this.height})
      : super(key: key);
      ...
      child: Shimmer.fromColors(
        ...
        child: Container(
          ...
          padding: EdgeInsets.symmetric(
              vertical: height! / 40.0, horizontal: height! / 40.0),
          child: Column(
            ...
            children: [
              ...
              Container(
                margin: EdgeInsetsDirectional.only(
                    end: width! / 99.0, top: height! / 99.0),
                width: width,
    ...
    return Center(
      child: Shimmer.fromColors(
        ...
        child: Container(
          margin: EdgeInsetsDirectional.only(bottom: height! / 99.0),
          padding: EdgeInsets.symmetric(
              vertical: height! / 99.0, horizontal: height! / 99.0),
          child: Container(
            width: double.maxFinite,
